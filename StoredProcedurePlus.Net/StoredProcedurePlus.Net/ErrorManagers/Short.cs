...
namespace StoredProcedurePlus.Net.ErrorManagers
{
    internal static partial class Error
    {
        ...
        internal static Exception MaxValuePropertyValidationError(string propertyName, short actualValue, short allowedValue)
        {
        ...
        internal static Exception MinValuePropertyValidationError(string propertyName, short actualValue, short allowedValue)
        {
            throw new ArgumentException(
        ...
        internal static void CannotSetNullToNotNullableShortProperty(string propertyName)
        {
            throw new InvalidOperationException("Cannot set null value into non nullable short property : " + propertyName);
        }
        #endregion

        #region ValueNotAllowedError
        internal static void ValueNotAllowedError(string propertyName, short value, short[] allowedValuesOnly)
        {
